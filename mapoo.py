...
class mapoo(minqlx.Plugin):
    ...
    def __init__(self):
        self.mapoo_small_threshhold = 1
        self.mapoo_medium_threshhold = 5
        self.mapoo_large_threshhold = 8
        ...
        self.mapoo_small_threshhold = self.get_cvar("qlx_mapoo_small_threshhold")
        self.mapoo_medium_threshhold = self.get_cvar("qlx_mapoo_medium_threshhold")
        self.mapoo_large_threshhold = self.get_cvar("qlx_mapoo_large_threshhold")
